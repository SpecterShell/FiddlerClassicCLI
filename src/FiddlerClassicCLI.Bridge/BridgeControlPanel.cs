...
internal sealed partial class BridgeControlPanel : UserControl
{
    ...
    private readonly Label _serviceState = new Label { AutoSize = true, AccessibleName = "Service status", UseMnemonic = false, Text = "Not checked" };
    private readonly ServiceStatusIndicator _serviceIndicator = new ServiceStatusIndicator();
    ...
    private async Task RefreshCoreAsync()
    {
        ...
        _serviceIndicator.Running = service.Running;
    ...
    private async Task RunOperationAsync(Func<Task> operation, bool showErrors = true)
    {
        ...
        {
            _serviceIndicator.Running = null;
            _serviceState.Text = "Status unavailable";
