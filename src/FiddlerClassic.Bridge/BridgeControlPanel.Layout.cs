...
internal sealed partial class BridgeControlPanel
{
    private void BuildLayout()
    {
        ...
        root.Controls.Add(CreateVersionsGroup(), 0, 3);
    ...
    private GroupBox CreateServiceGroup()
    {
        ...
        AddRow(layout, "Status", _serviceState);
        AddRow(layout, "Loopback", _endpoint);

        AddRow(layout, "&Bind", _bindMode);
        AddRow(layout, "&Port", _port);
        AddFullRow(layout, CreateActions(_apply, _toggle, _copyEndpoint, _refresh));
