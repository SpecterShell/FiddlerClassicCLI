...
internal sealed class DaemonClient
{
    ...
    public async Task<DaemonStatus> EnsureStartedAsync(CancellationToken cancellationToken = default)
    {
        ...
        throw new DaemonClientException(
            ...
            $"Timed out starting the Fiddler Classic CLI daemon.{detail} Run 'fiddler-classic daemon status' for diagnostics.");
    }
        ...
        Action? onConnected = null)
    {
        ...
        catch (Exception exception) when (exception is IOException or UnauthorizedAccessException or JsonException)
        {
            throw new DaemonClientException(
                ...
                "The Fiddler Classic CLI daemon is unavailable. Run 'fiddler-classic daemon stop' and retry.",
                exception);
        }
    }
}
