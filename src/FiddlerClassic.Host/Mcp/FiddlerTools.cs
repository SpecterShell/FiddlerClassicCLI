...
internal sealed class FiddlerTools
{
    ...
    [Description("Attach Fiddler Classic as the Windows system proxy. This does not install or trust certificates.")]
    ...
    [Description("Detach Fiddler Classic from the Windows system proxy.")]
    ...
    [Description("Start here to list captured network requests and obtain request IDs. Returns metadata and stable ID-bound continuation fields; headers and bodies are never included.")]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ArgumentException("Specify either body or bodyBase64, not both.");
        }
