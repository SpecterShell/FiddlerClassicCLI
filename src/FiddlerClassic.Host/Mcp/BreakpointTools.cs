...
internal sealed class BreakpointTools
{
    ...
    public Task<BreakpointArmMutationResponse> Arm(
        ...
        [Description("Exact response status filter; response stage only.")] int? statusCode = null,
        [Description("Response content-type substring; response stage only.")] string? contentType = null,
