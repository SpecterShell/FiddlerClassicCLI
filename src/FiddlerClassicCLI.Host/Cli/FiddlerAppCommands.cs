...
internal static class FiddlerAppCommands
{
    ...
    public static Command Create(FiddlerAppService service, Option<bool> json)
    {
        ...
        var open = new Command("open", "Open Fiddler with -noattach, or report the existing process. Check status separately for bridge readiness.");
    ...
    private static Command CreateClose(FiddlerAppService service, Option<bool> json, bool restart)
    {
        ...
        var yes = new Option<bool>("--yes", "-y") { Description = "Confirm possible loss of unsaved captures. Fiddler dialogs require user interaction." };
        ...
        if (restart)
        {
            ...
            command.Validators.Add(result =>
            {
                ...
                {
                    result.AddError("--path and --pid cannot be combined.");
                }
            });
        }
    ...
    private static void WriteResult(FiddlerAppResult result)
    {
        ...
        {
            Console.WriteLine("Check status or doctor after Fiddler loads to confirm bridge readiness.");
        }
    }
}
