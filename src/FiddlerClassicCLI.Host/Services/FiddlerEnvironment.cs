...
{
    public const string BridgeAssemblyName = "FiddlerClassicCLI.Bridge.dll";
    public const string ProtocolAssemblyName = "FiddlerClassicCLI.Protocol.dll";
    ...
    /// </summary>
    /// <returns>Executable candidates, excluding unavailable registry entries.</returns>
